      ...
      <div className={`col-lg-4 col-md-6 col-sm-12 ${props.className}`}>
        <div className="card mb-4 shadow-sm" style={{ position: "relative" }}>
          ...
          <ul className="list-group list-group-flush">
            ...
            <li className="list-group-item">Longitude: {Number.parseFloat(props.body.longitude).toFixed(3)}</li>
            <li className="list-group-item">Size: {Number.parseFloat(props.body.size).toFixed(3)} sq. km</li>
            {props.body.water_temp ? <li className="list-group-item">Average Temperature: {props.body.water_temp}°C</li> : null}
            {props.body.wind_speedkmph ? <li className="list-group-item">Local Wind Speed: {props.body.wind_speedkmph} km/h</li> : null}
          </ul>
        </div>
      </div>
    );
