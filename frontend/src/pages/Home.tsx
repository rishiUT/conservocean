    ...
    <div>
      ...
      <div className="menu-section">
        ...
        <div className="text-content">
          ...
          <h2 className="heading">Water covers over 70% of Earth's surface. </h2>
          <h2 className="subheading">Explore Earth's oceans, marine life, and the impact of human factors</h2>
