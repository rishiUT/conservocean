...
class TestAPI(TestCase):
    ...
    def testMakeFish1(self):
        ...
        assert fish_dict['picture_url'] == \
            "https://www.fishbase.de/images/species/Abhia_m0.jpg"
        assert fish_dict['description'] == "Inhabits neritic and oceanic " +\
    ...
    def testMakeHuman(self):
        ...
        assert human_dict['description'] == "On November 10th 1988, the " +\
    ...
    def testFilterFish1(self):
        args = {'limit': 10, 'offset': None, 'species': None,
                'common_name': None, 'status': None, 'population_trend': None,
                'scientific_name': None, 'habitat': None, 'size_min': None,
                'size_max': None, 'genus': None, 'family': None}
        ...
        args = {'limit': 1, 'offset': 5, 'species': None, 'common_name': None,
                'status': None, 'population_trend': None,
                'scientific_name': None, 'habitat': None, 'size_min': None,
                'size_max': None, 'genus': None, 'family': None}
        fish_dict = filterFish(args, fish_list)
        assert len(fish_dict.keys()) == 3
    ...
    def testFilterFish2(self):
        args = {'limit': 10, 'offset': None, 'species': "hians",
                'common_name': None, 'status': None, 'population_trend': None,
                'scientific_name': None, 'habitat': None, 'size_min': None,
                'size_max': None, 'genus': None, 'family': None}
        fish_dict = filterFish(args, fish_list)
    ...
    def testFilterFish3(self):
        args = {'limit': None, 'offset': None, 'species': None,
                'common_name': "Night sergeant", 'status': None,
                'population_trend': None, 'scientific_name': None,
                'habitat': None, 'size_min': None, 'size_max': None,
                'genus': None, 'family': None}
        fish_dict = filterFish(args, fish_list)
        assert len(fish_dict['data']) == 1
    ...
    def testFilterFish4(self):
        args = {'limit': 10, 'offset': None, 'species': None,
                'common_name': None, 'status': "VU", 'population_trend': None,
                'scientific_name': None, 'habitat': None, 'size_min': None,
                'size_max': None, 'genus': None, 'family': None}
        fish_dict = filterFish(args, fish_list)
        for fish in fish_dict['data']:
    ...
    def testFilterFish5(self):
        args = {'limit': 10, 'offset': None, 'species': None,
                'common_name': None, 'status': None,
                'population_trend': "Stable", 'scientific_name': None,
                'habitat': None, 'size_min': None, 'size_max': None,
                'genus': None, 'family': None}
        fish_dict = filterFish(args, fish_list)
        for fish in fish_dict['data']:
    ...
    def testFilterFish6(self):
        args = {'limit': None, 'offset': None, 'species': None,
                'common_name': None, 'status': None, 'population_trend': None,
                'scientific_name': "Acanthurus guttatus", 'habitat': None,
                'size_min': None, 'size_max': None, 'genus': None,
                'family': None}
        fish_dict = filterFish(args, fish_list)
        assert len(fish_dict['data']) == 1
        ...
        args = {'limit': None, 'offset': None, 'species': None,
                'common_name': None, 'status': None, 'population_trend': None,
                'scientific_name': "845y674ytw734ykjgvhn34", 'habitat': None,
                'size_min': None, 'size_max': None, 'genus': None,
                'family': None}
        fish_dict = filterFish(args, fish_list)
    ...
    def testFilterWater1(self):
        args = {'name': 'Paiko Lagoon', "type": None, 'limit': None,
                'offset': None, 'lat_min': None, 'lat_max': None,
                'long_min': None, 'long_max': None, 'size_min': None,
                'size_max': None, 'temp_min': None, 'temp_max': None}
    ...
    def testFilterWater2(self):
        args = {'type': 'Bay', 'limit': 10, 'offset': None,
                'name': None, 'long_min': None, 'long_max': None, 
                'lat_min': None, 'lat_max': None, 'size_min': None,
                'size_max': None, 'temp_min': None, 'temp_max': None}
        water_dict = filterWater(args, water_list)
